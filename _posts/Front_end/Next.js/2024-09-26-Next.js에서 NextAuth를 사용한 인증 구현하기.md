...
[[Next.js에서 NextAuth를 사용한 인증 구현하기 Repo↗️]](https://github.com/MyNameSieun/Nextjs-Authentication-Default-Set.git)
...
> 사용자의 인증 상태에 따라 로그인 또는 로그아웃 버튼을 표시하는 Header 컴포넌트를 생성하자.
...
> 인증된 사용자만 접근할 수 있도록 설정하는 레이아웃이다.
